...
const QrSchema = new Schema({
  ...
  mail: { type: String, required: false },        // Correo electrónico del usuario
  usageCount: { type: Number, default: 0 },      // Contador de usos del QR
  startTime: { type: String, required: false },   // Hora de inicio permitida (HH:MM)
  endTime: { type: String, required: false },     // Hora de finalización permitida (HH:MM)
